...
add_row(app, 2, 'gp.Listbox(options)', lb_default)
...
add_row(app, 6, 'style.unselected_color = "lightblue"\nstyle.unselected_hover_color = "skyblue"', lb_unsel)
...
add_row(app, 7, 'style.font_name = "monospace"\nstyle.font_size = 18\nstyle.text_color = "purple", "magenta"', lb_text)
...
add_row(app, 4, 'style.corner_radius = 20\nstyle.border_width = 5', lb_style)
